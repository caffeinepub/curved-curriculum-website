...
export class Backend implements backendInterface {
    ...
    async getAllLeads(): Promise<Array<ProspectusLead>> {
    ...
    async getAllSubmissions(): Promise<Array<InquirySubmission>> {
        if (this.processError) {
            try {
    ...
    async submitInquiry(arg0: InquirySubmission): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitLead(arg0: ProspectusLead): Promise<void> {
        if (this.processError) {
            try {
